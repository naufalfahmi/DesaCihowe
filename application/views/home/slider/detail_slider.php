                    ...
                    <!-- post featured & title -->
                        <div class="row">
                            ...
                            <div class="the-content span6">
                                <div>
                                    <img height="600px" width="auto" src="<?PHP echo base_url().'assets/img/slider/'.$detail_slider['foto'];?>" alt="icon-comment" />
                                </div>

                            </div> 
                            <!-- post content -->
                            <div class="the-content single group span9"><br>
                                <h4><?php echo $detail_slider['slider_desc'];?></h4>
                            </div>
                        </div>
                </div>
