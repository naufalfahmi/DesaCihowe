                    ...
                    <!-- post featured & title -->
                        <div class="row">
                            ...
                            <div class="meta group span3">
                                <div><br>
                                    ...
                                    <p class="date">
                                        ...
                                        <span>Date:</span><?php echo $konten['tgl_dibuat'];?><hr>
                                    </p>
                                </div>
                            ...
                            <div class="the-content span6">
                                <div>
                                    <img height="600px" width="auto" src="<?PHP echo base_url().'assets/img/konten/'.$konten['foto'];?>" alt="icon-comment" />
                                </div>

                            </div> 
                            <!-- post content -->
                            <div class="the-content single group span9"><br>
                                <h4><?php echo $konten['isi'];?></h4>
                            </div>
                        </div>
                </div>
